...
@section('title', __('Create publisher'))
    ...
    <div class="py-6">
        ...
        <nav class="bg-gray-50 px-6 py-3 text-gray-700">
            <ol class="list-reset flex text-sm">
                ...
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-500">{{ __('Create publisher') }}</li>
            </ol>
        </nav>
        ...
        <main class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">{{ __('Create publisher') }}</h1>
                    <p class="text-gray-600 mt-1">{{ __('Add new publisher details') }}</p>
                </div>
                <div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('publishers.store') }}" class="space-y-6">
                @csrf
