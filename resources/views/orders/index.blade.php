...
@section('content')
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        ...
        <main class="mt-6 bg-gray-50 rounded-xl shadow-sm p-6 sm:p-8">
            ...
            <!-- Orders Table -->
            <div class="relative">
                <form id="includeDeletedForm" class="absolute top-4 right-4 flex items-center gap-2">
                    <x-input-choice name="include_deleted" value="1" :label="__('Include Cancelled Orders')" :checked="request('include_deleted')"
                        onchange="document.getElementById('includeDeletedForm').submit();" />
                </form>
