    ...
    <div class="py-6">
        ...
        <nav class="bg-gray-50 px-6 py-3 text-gray-700">
            <ol class="list-reset flex text-sm">
                ...
                <li><a href="{{ route('authors.index') }}"
                        class="text-blue-600 hover:text-blue-800">{{ __('Author management') }}</a></li>
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-500">{{ __('Edit author') }}</li>
            </ol>
        </nav>
        ...
        <main class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">{{ __('Edit author') }}</h1>
                    <p class="text-gray-600 mt-1">{{ __('Update author details') }}</p>
                </div>
                <div>
            ...
            <form method="POST" action="{{ route('authors.update', $author) }}" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 space-y-6">
                    <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-3">
                        <i class="fas fa-info-circle mr-2 text-blue-500"></i>{{ __('Author information') }}
                    </h3>
                    ...
                    <div>
                        ...
                        <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug"
                            :value="old('slug', $author->slug)" required autocomplete="slug" />
                    ...
                    <div>
                        ...
                        <x-textarea id="description" class="block mt-1 w-full" name="description"
                            autocomplete="description">{{ old('description', $author->description) }}</x-textarea>
