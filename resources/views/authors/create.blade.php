    ...
    <div class="py-6">
        ...
        <nav class="bg-gray-50 px-6 py-3 text-gray-700">
            <ol class="list-reset flex text-sm">
                ...
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-500">{{ __('Create author') }}</li>
            </ol>
        </nav>
        ...
        <main class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">{{ __('Create author') }}</h1>
                    <p class="text-gray-600 mt-1">{{ __('Add new author details') }}</p>
                </div>
                <div>
