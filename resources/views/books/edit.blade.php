                                    ...
                                    <select name="author_id" id="author_id"
                                        ...
                                        @foreach ($authors as $author)
                                            <option value="{{ $author->id }}"
                                                {{ old('author_id', $book->author->id ?? null) === $author->id ? 'selected' : '' }}>
                                                {{ $author->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="publisher_id" id="publisher_id"
                                        ...
                                        @foreach ($publishers as $publisher)
                                            <option value="{{ $publisher->id }}"
                                                {{ old('publisher_id', $book->publisher->id ?? null) === $publisher->id ? 'selected' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="pages" id="pages"
                                        value="{{ old('pages', $book->pages) }}" min="0"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="weight" id="weight"
                                        value="{{ old('weight', $book->weight) }}" min="0"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <select name="cover_type" id="cover_type"
                                        ...
                                        @foreach ($coverTypes as $key => $label)
                                            <option value="{{ $key }}"
                                                {{ old('cover_type', $book->cover_type) === $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="original_price" id="original_price"
                                            value="{{ old('original_price', $book->original_price) }}" min="0"
                                            step="0.01"
