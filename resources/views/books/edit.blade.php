        ...
        <main class="mt-6 bg-gray-50 rounded-xl shadow-sm p-6 sm:p-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-1 text-sm">{{ __('Update the details of the book.') }}</p>
                </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('books.update', $book) }}" class="space-y-6" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-lg shadow-sm p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" name="title" type="text" :value="old('title', $book->title)" required
                            ...
                            <div>
                                ...
                                <x-text-input id="slug" name="slug" type="text" :value="old('slug', $book->slug)" required
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-select id="author_id" name="author_id" :options="$authors->pluck('name', 'id')->toArray()"
                                        placeholder="{{ __('Select author') }}" :selected="old('author_id', $book->author_id)" />
                                ...
                                <div>
                                    ...
                                    <x-select id="publisher_id" name="publisher_id" :options="$publishers->pluck('name', 'id')->toArray()"
                                        placeholder="{{ __('Select publisher') }}" :selected="old('publisher_id', $book->publisher_id)" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="isbn" name="isbn" type="text" :value="old('isbn', $book->isbn)"
                                ...
                                <div>
                                    ...
                                    <x-select id="language" name="language" :options="$languages"
                                        placeholder="{{ __('Select language') }}" :selected="old('language', $book->language)" />
                            ...
                            <div>
                                ...
                                <x-textarea id="description" name="description" autocomplete="description"
                                    placeholder="{{ __('Enter book description') }}">{{ old('description', $book->description) }}</x-textarea>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 space-y-6 mt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="pages" name="pages" type="number" :value="old('pages', $book->pages)"
                                ...
                                <div>
                                    ...
                                    <x-select id="dimensions" name="dimensions" :options="$dimensions"
                                        placeholder="{{ __('Select dimensions') }}" :selected="old('dimensions', $book->dimensions)" />
                                    <x-input-error :messages="$errors->get('dimensions')" class="mt-2" />
                                </div>
                                <div>
                                    <x-form-label for="weight" value="Weight (g)" icon="fas fa-weight" />
                                    <x-text-input id="weight" name="weight" type="number" :value="old('weight', $book->weight)"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-select id="cover_type" name="cover_type" :options="$coverTypes"
                                        placeholder="{{ __('Select cover type') }}" :selected="old('cover_type', $book->cover_type)" />
                                ...
                                <div
                                    ...
                                    <label class="cursor-pointer">
                                        ...
                                        <input type="file" name="images[]" id="file-input" accept="image/*" multiple
                                            class="hidden">
                                        <div id="existing-image-ids-container"></div>
                                    </label>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-select id="categories" name="categories[]" :options="$categories->pluck('name', 'id')->toArray()"
                                    placeholder="{{ __('Select categories') }}" :selected="old('categories', $book->categories->pluck('id')->toArray())" multiple
                                    size="10" />
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <x-text-input id="original_price" name="original_price" type="number"
                                            :value="old('original_price', $book->original_price)" min="0" step="0.01" placeholder="0" />
                                        <span class="absolute right-3 top-2 text-gray-500">{{ __('VND') }}</span>
                                    </div>
                                    <x-input-error :messages="$errors->get('original_price')" class="mt-2" />
                                </div>
                                <div>
                                    <x-form-label for="sale_price" value="Sale Price" icon="fas fa-tag" required />
                                    <div class="relative">
                                        <x-text-input id="sale_price" name="sale_price" type="number" :value="old('sale_price', $book->sale_price)"
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 space-y-6 mt-6">
                            ...
                            <div>
                                ...
                                <x-select id="status" name="status" :options="$statuses"
                                    placeholder="{{ __('Select status') }}" :selected="old('status', $book->status)" />
                ...
                <div class="flex items-center gap-4 pt-6 border-t border-gray-100">
                    <x-primary-button name="update_type" value="all">
