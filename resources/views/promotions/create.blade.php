        ...
        <main class="mt-6 bg-gray-50 rounded-xl shadow-sm p-6 sm:p-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-1 text-sm">{{ __('Add a new promotion to the system.') }}</p>
                </div>
                <div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="discount_percentage" name="discount_percentage" type="number" step="0.01"
                            :value="old('discount_percentage')" required placeholder="{{ __('Enter discount percentage') }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="max_discount_amount" name="max_discount_amount" type="number" step="0.01"
                            :value="old('max_discount_amount')" placeholder="{{ __('Enter max discount amount') }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="min_order_amount" name="min_order_amount" type="number" step="0.01"
                            :value="old('min_order_amount')" placeholder="{{ __('Enter minimum order amount') }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="max_usage_count" name="max_usage_count" type="number" step="1"
                            :value="old('max_usage_count')" placeholder="{{ __('Enter max usage count') }}" />
                    ...
                    <div>
                        ...
                        <input type="checkbox" id="is_active" name="is_active" value="1"
                            {{ old('is_active', 1) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-500">
                    ...
                    <div>
                        ...
                        <x-text-input id="start_date" name="start_date" type="datetime-local" :value="old('start_date')"
                    ...
                    <div>
                        ...
                        <x-text-input id="end_date" name="end_date" type="datetime-local" :value="old('end_date')"
